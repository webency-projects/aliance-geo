...
test_1 = [[100, 0], [150, 0], [180, 0], [200, 0]]
test_1_ans = [[100, 0], [150, 0], [180, 0], [-160, 0]]

test_2 = [[100, 0], [150, 0], [180, 0], [150, 0]]
test_2_ans = [[100, 0], [150, 0], [180, 0], [150, 0]]
...
class TestCoordinates(unittest.TestCase):
    ...
    def test_check_results(self):
        ...
        for i, item in enumerate(results[0]):
            self.assertEqual(item[0], test_1_ans[i][0])
    ...
    def test_check_results_not_change(self):
        ...
        for i, item in enumerate(results[0]):
            self.assertEqual(item[0], test_2[i][0])
            self.assertEqual(item[0], test_2_ans[i][0])
...
message_test_2 = json.dumps({"type":"Feature","properties":{"name":"London"},"geometry":{"type":"Polygon","coordinates":[[[-0.455933,16.167197],[181.077428, -1.290894],[-0.093384,14.562318],[1.032715,15.538376],[-0.455933,16.167197]]]}})
